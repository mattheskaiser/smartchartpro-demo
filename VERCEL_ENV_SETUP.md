...
_Note: This environment variable is no longer used for authentication. The master password is now stored securely in the database and managed through the Admin Settings UI._
