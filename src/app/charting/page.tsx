...
export default function ChartingPage() {
  ...
  const [selectedAssistance, setSelectedAssistance] = useState<'independent' | 'partial' | 'full' | null>(null);
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <TextAtom className="mt-2 text-gray-600">
                Choose which resident you'd like to chart for
              </TextAtom>
            </div>
            <div className="flex items-center space-x-2 text-sm text-gray-500">
              <DynamicIconAtom name="Users" size="sm" />
              <span>{selectedResidents.length} residents available</span>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-7xl p-6 space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center space-x-4 mt-1">
                  ...
                  <BadgeAtom variant={getStatusVariant(currentResident?.status || '')}>
                    {currentResident?.status?.charAt(0).toUpperCase() + currentResident?.status?.slice(1)}
                  </BadgeAtom>
                </div>
              </div>
            </div>
        ...
        <CardAtom className="bg-gray-50 border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <DynamicIconAtom
                name={selectedADL && selectedAssistance ? "CheckCircle" : "Circle"}
                size="sm"
