...
export async function GET(
    ...
    try {
        ...
        return NextResponse.json(
            { error: 'Failed to fetch charting report' },
            { status: 500 }
        );
    }
}
...
export async function PATCH(
    ...
    try {
        ...
        if (reviewedAt !== undefined)
            updateData.reviewedAt = reviewedAt ? new Date(reviewedAt) : null;
        ...
        return NextResponse.json(
            { error: 'Failed to update charting report' },
            { status: 500 }
        );
    }
}
...
export async function DELETE(
    ...
    try {
        ...
        return NextResponse.json(
            { error: 'Failed to delete charting report' },
            { status: 500 }
        );
    }
}
