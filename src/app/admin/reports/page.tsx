        ...
        <div className="mx-auto max-w-7xl p-6 space-y-6">
            ...
            {reports.length === 0 ? (
                ...
                <div className="space-y-3">
                    {reports.map(report => (
                        <div key={report.id} className="bg-white rounded-lg border border-gray-200 p-4 hover:border-gray-300 transition-colors">
                                    ...
                                    <div>
                                        <div className="flex items-baseline gap-2">
                                            ...
                                            <TextAtom variant="small" className="text-gray-500">
                                                {format(new Date(report.sessionStartTime), 'h:mm a')} - {format(new Date(report.sessionEndTime), 'h:mm a')}
                                            </TextAtom>
                                        </div>
                                        <TextAtom variant="small" className="text-gray-600">
                                            {report.cnaName || 'Not specified'} • {report.totalResidents} residents • {report.totalActivities} activities
                                        </TextAtom>
                                    </div>
                                </div>
