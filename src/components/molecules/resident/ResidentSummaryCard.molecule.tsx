  ...
  return (
    <CardAtom>
      <div className="flex items-center space-x-4 mb-4">
        ...
        <div>
          <TextAtom variant="h3" weight="medium">{resident.name}</TextAtom>
          <TextAtom variant="small" color="muted">Room {resident.room}</TextAtom>
        </div>
      </div>
      <div className="space-y-2">
        <div className="flex justify-between">
          <TextAtom variant="small" color="muted">Last ADL:</TextAtom>
          <TextAtom variant="small">{resident.lastADL}</TextAtom>
        </div>
        <div className="flex justify-between">
          <TextAtom variant="small" color="muted">Status:</TextAtom>
