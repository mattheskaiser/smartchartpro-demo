    ...
    return (
        ...
        >
            ...
            <div className="mb-6">
                ...
                <SelectAtom
                    value={selectedCNA}
                    onChange={(e) => setSelectedCNA(e.target.value)}
                    required
                >
                ...
                {selectedCNAData && (
                    <div className="mt-3 p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                            <AvatarAtom
                                src={selectedCNAData.imageData}
                                alt={selectedCNAData.name}
                                size="sm"
                            />
                            <div>
                                ...
                                <TextAtom variant="small" className="text-gray-500">
                                    {selectedCNAData.certificationNumber && `Cert: ${selectedCNAData.certificationNumber}`}
                                </TextAtom>
                            </div>
                        </div>
                    </div>
            ...
            <div className="mb-6">
                <div className="flex items-center justify-between mb-3">
                    <LabelAtom>Assign Residents ({selectedResidents.length}/{maxResidents})</LabelAtom>
                    <div className="flex gap-2">
                        ...
                        <ButtonAtom
                            variant="ghost"
                            size="sm"
                            onClick={() => setSelectedResidents(availableResidents.slice(0, maxResidents).map(r => r.id))}
                            type="button"
                        >
                            Select All
                        </ButtonAtom>
