    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          success:
            'group-[.toast]:border-green-300 group-[.toast]:bg-white [&>div>svg]:text-green-600 [&>div>div>div:first-child]:text-green-900 [&>div>div>div:last-child]:text-green-700',
          error:
            'group-[.toast]:border-red-300 group-[.toast]:bg-white [&>div>svg]:text-red-600 [&>div>div>div:first-child]:text-red-900 [&>div>div>div:last-child]:text-red-700',
          warning:
            'group-[.toast]:border-yellow-300 group-[.toast]:bg-white [&>div>svg]:text-yellow-600 [&>div>div>div:first-child]:text-yellow-900 [&>div>div>div:last-child]:text-yellow-700',
